...
$btcmarkets = new build\ccxt\btcmarkets(array (
...
$gdax = new build\ccxt\gdax();

$kraken = new build\ccxt\kraken();

$bitcoincoid = new build\ccxt\bitcoincoid(array(
...
$poloniex = new build\ccxt\poloniex(array (
...
$btcmarkets_tickers = $poloniex->fetch_ticker("BTC/USDT");
